...
try:
    ...
    for registro in cur.fetchall():
        publication_name, report_name, url, main_tag, atr, publicated_month_tag, \
        *others_fields, salir_luego_primer_tag = registro
        ...
        #print(f"Tiempo en Segundos para {publication_name} {report_name}
        ...
        for firsts_tags in first_main_tags:
            ...
            lineas_a_imprimir.append([publication_name, report_name,
                    estado]
                    )
    ...
    with open("International_Investments.csv", "w") as csvfile:
        ...
        writer.writerow(
                ["Publication Name", "Report Name", "Last Publication Date"]
                )
